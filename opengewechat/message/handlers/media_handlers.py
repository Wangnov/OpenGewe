...
from opengewechat.message.models import (
    ImageMessage,
    VoiceMessage,
    VideoMessage,
    EmojiMessage,
...
class ImageMessageHandler(BaseHandler):
    ...
    def handle(self, data: Dict[str, Any]) -> Optional[ImageMessage]:
        """处理图片消息"""
...
class VoiceMessageHandler(BaseHandler):
    ...
    def handle(self, data: Dict[str, Any]) -> Optional[VoiceMessage]:
        """处理语音消息"""
...
class VideoMessageHandler(BaseHandler):
    ...
    def handle(self, data: Dict[str, Any]) -> Optional[VideoMessage]:
        """处理视频消息"""
...
class EmojiMessageHandler(BaseHandler):
    ...
    def handle(self, data: Dict[str, Any]) -> Optional[EmojiMessage]:
        """处理表情消息"""
