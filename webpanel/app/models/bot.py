...
class BotInfo(Base):
    ...
    gewe_app_id: Mapped[str] = mapped_column(String(100), unique=True, nullable=False, index=True)
...
class Contact(Base):
    ...
    contact_type: Mapped[ContactType] = mapped_column(Enum(ContactType), nullable=False, index=True)
